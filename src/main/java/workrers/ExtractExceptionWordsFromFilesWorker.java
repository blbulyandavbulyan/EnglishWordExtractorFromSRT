...
public class ExtractExceptionWordsFromFilesWorker extends SwingWorker<Set<String>, String> {
    private final Collection<File> exceptionWordsFiles;
    private final Predicate<Character> isValidChar;

    public ExtractExceptionWordsFromFilesWorker(Collection<File> exceptionWordsFiles, Predicate<Character> isValidChar) {
    ...
    protected Set<String> doInBackground() throws Exception {
        long maxReadBytes = exceptionWordsFiles.stream().mapToLong(File::length).sum();
